...
extension SettingsViewController {
    ...
    private var dataSection: TableViewSectionViewModel {
        ...
        let sectionViewModel = TableViewSectionViewModel(header: "Data".localized(), footer: "Radarbug doesn't sync, but".localized(), rows: [importCellViewModel, exportCellViewModel, backupCellViewModel, restoreCellViewModel])
        return sectionViewModel
    }

    private var aboutSection: TableViewSectionViewModel {
        let rateCellViewModel = TableViewCellViewModel(title: "Privacy Policy".localized()) {
        ...
        let developerCellViewModel = TableViewCellViewModel(title: "Developer".localized(), subtitle: "@Dolphqiqu", cellStyle: .value1) {
